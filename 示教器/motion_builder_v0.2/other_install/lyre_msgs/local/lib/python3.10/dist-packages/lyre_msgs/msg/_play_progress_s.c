...
bool lyre_msgs__msg__play_progress__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.msg._play_progress.PlayProgress", full_classname_dest, 41) == 0);
  }
  lyre_msgs__msg__PlayProgress * ros_message = _ros_message;
  {  // sid
...
{
  /* NOTE(esteve): Call constructor of PlayProgress */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.msg._play_progress");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayProgress");
