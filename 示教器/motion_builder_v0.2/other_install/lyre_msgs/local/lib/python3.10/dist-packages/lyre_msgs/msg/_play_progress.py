...
class Metaclass_PlayProgress(type):
    """Metaclass of message 'PlayProgress'."""
    ...
    __constants = {
        'TOPIC_NAME': '/audio_play/progress',
    }
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'lyre_msgs.msg.PlayProgress')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__play_progress
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__play_progress
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__play_progress
            cls._TYPE_SUPPORT = module.type_support_msg__msg__play_progress
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__play_progress
    ...
    def TOPIC_NAME(self):
        ...
        return Metaclass_PlayProgress.__constants['TOPIC_NAME']


class PlayProgress(metaclass=Metaclass_PlayProgress):
    """
    Message class 'PlayProgress'.
