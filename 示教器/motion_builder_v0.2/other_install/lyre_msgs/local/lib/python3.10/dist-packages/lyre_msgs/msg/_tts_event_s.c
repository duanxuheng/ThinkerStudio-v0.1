...
bool lyre_msgs__msg__tts_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.msg._tts_event.TtsEvent", full_classname_dest, 33) == 0);
  }
  lyre_msgs__msg__TtsEvent * ros_message = _ros_message;
  {  // sid
...
{
  /* NOTE(esteve): Call constructor of TtsEvent */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.msg._tts_event");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TtsEvent");
