...
class Metaclass_PlayEvent(type):
    """Metaclass of message 'PlayEvent'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'lyre_msgs.msg.PlayEvent')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__play_event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__play_event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__play_event
            cls._TYPE_SUPPORT = module.type_support_msg__msg__play_event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__play_event
    ...
    def TOPIC_NAME(self):
        ...
        return Metaclass_PlayEvent.__constants['TOPIC_NAME']

    @property
    def EVENT_STARTED(self):
        """Message constant 'EVENT_STARTED'."""
        return Metaclass_PlayEvent.__constants['EVENT_STARTED']

    @property
    def EVENT_COMPLETED(self):
        """Message constant 'EVENT_COMPLETED'."""
        return Metaclass_PlayEvent.__constants['EVENT_COMPLETED']

    @property
    def EVENT_STOPPED(self):
        """Message constant 'EVENT_STOPPED'."""
        return Metaclass_PlayEvent.__constants['EVENT_STOPPED']

    @property
    def EVENT_CANCELLED(self):
        """Message constant 'EVENT_CANCELLED'."""
        return Metaclass_PlayEvent.__constants['EVENT_CANCELLED']

    @property
    def EVENT_FAILED(self):
        """Message constant 'EVENT_FAILED'."""
        return Metaclass_PlayEvent.__constants['EVENT_FAILED']


class PlayEvent(metaclass=Metaclass_PlayEvent):
    """
    Message class 'PlayEvent'.
