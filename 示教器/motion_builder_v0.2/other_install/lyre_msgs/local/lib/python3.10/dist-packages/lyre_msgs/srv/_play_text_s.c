...
bool lyre_msgs__srv__play_text__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.srv._play_text.PlayText_Request", full_classname_dest, 41) == 0);
  }
  lyre_msgs__srv__PlayText_Request * ros_message = _ros_message;
  {  // sid
...
{
  /* NOTE(esteve): Call constructor of PlayText_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.srv._play_text");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayText_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool lyre_msgs__srv__play_text__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.srv._play_text.PlayText_Response", full_classname_dest, 42) == 0);
  }
  lyre_msgs__srv__PlayText_Response * ros_message = _ros_message;
  {  // sid
    PyObject * field = PyObject_GetAttrString(_pymsg, "sid");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of PlayText_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.srv._play_text");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayText_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
