...
bool lyre_msgs__srv__play_binary__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.srv._play_binary.PlayBinary_Request", full_classname_dest, 45) == 0);
  }
  lyre_msgs__srv__PlayBinary_Request * ros_message = _ros_message;
  {  // sid
...
{
  /* NOTE(esteve): Call constructor of PlayBinary_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.srv._play_binary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayBinary_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool lyre_msgs__srv__play_binary__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lyre_msgs.srv._play_binary.PlayBinary_Response", full_classname_dest, 46) == 0);
  }
  lyre_msgs__srv__PlayBinary_Response * ros_message = _ros_message;
  {  // sid
    PyObject * field = PyObject_GetAttrString(_pymsg, "sid");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of PlayBinary_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lyre_msgs.srv._play_binary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayBinary_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
