...
lyre_msgs__msg__PlayEvent__init(lyre_msgs__msg__PlayEvent * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->sid)) {
    lyre_msgs__msg__PlayEvent__fini(msg);
    return false;
  }
  // seq
  // event
...
lyre_msgs__msg__PlayEvent__create()
{
  ...
  lyre_msgs__msg__PlayEvent * msg = (lyre_msgs__msg__PlayEvent *)allocator.allocate(sizeof(lyre_msgs__msg__PlayEvent), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lyre_msgs__msg__PlayEvent));
  bool success = lyre_msgs__msg__PlayEvent__init(msg);
  if (!success) {
...
lyre_msgs__msg__PlayEvent__Sequence__init(lyre_msgs__msg__PlayEvent__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lyre_msgs__msg__PlayEvent * data = NULL;

  if (size) {
    data = (lyre_msgs__msg__PlayEvent *)allocator.zero_allocate(size, sizeof(lyre_msgs__msg__PlayEvent), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lyre_msgs__msg__PlayEvent__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lyre_msgs__msg__PlayEvent__fini(&data[i - 1]);
      }
...
lyre_msgs__msg__PlayEvent__Sequence__fini(lyre_msgs__msg__PlayEvent__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lyre_msgs__msg__PlayEvent__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lyre_msgs__msg__PlayEvent__Sequence * array = (lyre_msgs__msg__PlayEvent__Sequence *)allocator.allocate(sizeof(lyre_msgs__msg__PlayEvent__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lyre_msgs__msg__PlayEvent__Sequence__init(array, size);
  if (!success) {
...
lyre_msgs__msg__PlayEvent__Sequence__destroy(lyre_msgs__msg__PlayEvent__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lyre_msgs__msg__PlayEvent__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lyre_msgs__msg__PlayEvent__Sequence__are_equal(const lyre_msgs__msg__PlayEvent__Sequence * lhs, const lyre_msgs__msg__PlayEvent__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lyre_msgs__msg__PlayEvent__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lyre_msgs__msg__PlayEvent__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lyre_msgs__msg__PlayEvent);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lyre_msgs__msg__PlayEvent * data =
      (lyre_msgs__msg__PlayEvent *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lyre_msgs__msg__PlayEvent__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lyre_msgs__msg__PlayEvent__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lyre_msgs__msg__PlayEvent__copy(
