...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AsrEvent_message_member_array[3] = {
  {
    "event",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lyre_msgs::msg::AsrEvent, arg2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
