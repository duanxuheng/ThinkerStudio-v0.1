...
#ifndef LYRE_MSGS__SRV__DETAIL__LLM_ASK__FUNCTIONS_H_
#define LYRE_MSGS__SRV__DETAIL__LLM_ASK__FUNCTIONS_H_
...
/// Create srv/LlmAsk message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lyre_msgs__srv__LlmAsk_Request__init().
...
/// Destroy srv/LlmAsk message.
/**
 * It calls
 * lyre_msgs__srv__LlmAsk_Request__fini()
...
/// Check for srv/LlmAsk message equality.
/**
...
/// Initialize array of srv/LlmAsk messages.
/**
...
/// Finalize array of srv/LlmAsk messages.
/**
 * It calls
 * lyre_msgs__srv__LlmAsk_Request__fini()
...
/// Create array of srv/LlmAsk messages.
/**
 * It allocates the memory for the array and calls
 * lyre_msgs__srv__LlmAsk_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LlmAsk messages.
/**
 * It calls
 * lyre_msgs__srv__LlmAsk_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LlmAsk message array equality.
/**
...
/// Copy an array of srv/LlmAsk messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lyre_msgs__srv__LlmAsk_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lyre_msgs
...
/**
 * It calls
 * lyre_msgs__srv__LlmAsk_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lyre_msgs
...
/**
 * It allocates the memory for the array and calls
 * lyre_msgs__srv__LlmAsk_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lyre_msgs
...
/**
 * It calls
 * lyre_msgs__srv__LlmAsk_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LYRE_MSGS__SRV__DETAIL__LLM_ASK__FUNCTIONS_H_
