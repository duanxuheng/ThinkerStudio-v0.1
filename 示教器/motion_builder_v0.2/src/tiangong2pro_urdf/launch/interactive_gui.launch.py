...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument(
            name='startup_zero',
            default_value='true',
            description='Auto-send zero pose on startup without prompt (true/false)',
        ),
    ]
    ...
    interactive_gui_node = Node(
        package='tiangong2pro_urdf',
        executable='interactive_gui.py',
        name='interactive_gui',
        output='screen',
        parameters=[{
            'startup_zero': launch_ros.parameter_descriptions.ParameterValue(
